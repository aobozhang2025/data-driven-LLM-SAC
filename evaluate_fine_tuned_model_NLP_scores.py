...
def evaluate(candidates_file_path, references_file_path, save_path):
    sal = String_array_loader()

    system_messages, user_messages, bot_messages = sal.parse_eval_outputs(candidates_file_path)
...
if __name__ == "__main__":
    evaluate(
        r".\data\logs\Baichuan2-7B-base\eval_outputs_iter_399.txt",
        r".\data\testing_txt\testing_answers.txt",
        r".\data\NLP_metrics\Baichuan2-7B-Base.csv"
    )
    evaluate(
        r".\data\logs\Llama-3-8B\eval_outputs_iter_399.txt",
        r".\data\testing_txt\testing_answers.txt",
        r".\data\NLP_metrics\Llama-3-8B.csv"
    )
    evaluate(
        r".\data\logs\Qwen1.5-7B\eval_outputs_iter_399.txt",
        r".\data\testing_txt\testing_answers.txt",
        r".\data\NLP_metrics\Qwen1.5-7B.csv"
    )