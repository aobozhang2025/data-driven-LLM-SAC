...
#######################################################################
# Model
pretrained_model_name_or_path = "/data/home/scyb178/models/Qwen/Qwen1.5-7B"
use_varlen_attn = False

# Data
# alpaca_en_path = "/data/home/scyb178/data/"
data_dir = "/data/home/scyb178/data/20250727"
prompt_template = PROMPT_TEMPLATE.default
max_length = 2048 # max output text length
pack_to_max_length = True # package short data into one long, in order to improve efficiency

# parallel
sequence_parallel_size = 1

# Scheduler & Optimizer
batch_size = 50  # per_device, sample size every epoch
...
evaluation_freq = 200 # usually same as save_steps
...
model = dict(
    ...
    lora=dict(
        type=LoraConfig,
        r=64,   # scope of change, overfit if too large
        lora_alpha=128,    # usually one or two times r
        lora_dropout=0.1,
        bias="none",
        task_type="CAUSAL_LM",
    ),
